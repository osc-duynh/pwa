...
import customClassesWithLess from './headerLess.module.less';
import customClassWithScss from './headerCustome.module.scss';
...
const Header = props => {
    ...
    const classes = useStyle({...defaultClasses, ...customClassesWithLess, ...customClassWithScss}, props.classes);
    ...
    return (
        <Fragment>
            ...
            <header className={rootClass}>
                <div className={ClassList(classes.toolbar, classes.toolbar1, classes.toolbar2)}>
